...
# Lissajous candidate: 3:4 with pi/4 phase shift.
...
drawPath(build_lissajous_path(cx, cy, curve_scale_x, curve_scale_y, 3, 4, math.pi / 4))

# Save
if shouldSave:
    filename = os.path.join(
        EXPORTS,
        "blog-future-software-development-is-multi-model-lissajous-3-4-"
