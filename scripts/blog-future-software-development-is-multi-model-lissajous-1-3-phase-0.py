...
# Lissajous candidate: 1:3 with zero phase shift.
...
drawPath(build_lissajous_path(cx, cy, curve_scale_x, curve_scale_y, 1, 3, 0))

# Save
if shouldSave:
    filename = os.path.join(
        EXPORTS,
        "blog-future-software-development-is-multi-model-lissajous-1-3-phase-0-"
