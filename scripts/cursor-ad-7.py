...
# Karl -> Oskar
# Alexander -> Sasha
# Samantha -> Sam (Moberly, Whitmore)
# Jun Tao Max -> Max
# Stephanie -> Steph (Wolff)
names = ["Sualeh", "Aman", "Michael", "Rishabh", "Ian", "Phillip", "Fausto", "Baltazar", "Federico", "Luke", "Aman", "Zack", "Jordan", "Oskar", "Jacob", "Vicent", "Michael", "Lukas", "Eric", "Lujing", "Ravi", "Roman", "Dan", "Henry", "Jonathan", "Adam", "Pavan", "Bennett", "Nicholas", "Ryo", "Jeremy", "Grace", "Dylan", "Stefan", "Sasha", "Connor", "Yuchen", "Emily", "Alex", "David", "Lee", "Yash", "Max", "Jon", "Tomer", "Tahirih", "Shomil", "Charlie", "Jon", "Matt", "Kash", "Rachel", "Shengtong", "Taylor", "Jediah", "Rikki", "Emma", "Michiel", "Justin", "Eric", "Rohan", "Yury", "Robbie", "Ali", "Ricky", "Michael", "Ben", "Samantha", "Marisa", "Sujay", "Daniel", "Rachel", "George", "Isaac", "Vibhav", "Tony", "Alex", "Yurii", "Leo", "Kody", "Zhiyuan", "David", "Will", "Alexander", "Mia", "Daniel", "Ren", "Max", "Jason", "Andrew", "Nate", "Brooke", "Jack", "Morgan", "Ryan", "Noor", "Ryan", "Brookey", "Stuart", "Kevin", "Anatole", "Mark", "Peter", "Rohan", "Zach", "Kristina", "Lee", "YuQin", "Casey", "John", "Nelson", "Alexey", "Noah", "David", "Travis", "Naman", "Ahmed", "Henry", "Emily", "Austin", "Aaron", "Wanqi", "Beth", "Ben", "Joshua", "Sam", "Hugo", "James", "Tido", "Tess", "Netto", "Roshni", "Tyler", "Matthew", "Jai", "Less", "Derek", "Jesse", "Maya", "Omer", "Al", "Rohan", "Jacob", "Danny", "Michael", "Kirill", "Diggory", "Krista", "Sasha", "Nick", "Allegra", "Tina", "Jonathan", "Joe", "Joel", "Sabiha", "Hanpeng", "Emily", "Mathew", "Adam", "Katie", "Matt", "Steph", "Max", "Ani", "Jenna", "Ashvin", "Tom", "Haoyu", "Andrew", "William", "Roy", "Allison", "Nathan", "Audrey", "Albert", "Dan", "Jack", "Kevin", "Denzil", "David", "Sally", "Vincent", "Nini", "Ryan", "Tommy", "Daniel", "Andrew", "Wilson", "Jordan", "Ella", "Ben", "Cade", "Karthik", "David", "Jack", "Alexander", "Jonas", "Kevin", "Jet", "Jonathan", "Jason", "Sam", "Aaron", "Alex", "Zoë", "Mark", "Frances", "Mateo", "Katie", "Jack", "Oleg", "Shivam", "Adam", "Nate", "Mike", "Adam", "Aidan", "Paul", "Vivek", "Dave", "Kelly", "Parker", "Will", "Patty", "Dean", "Francisco", "Kenan", "Nicholas", "Edwin", "Patrick", "Sally", "Joe", "Jack", "Kevin", "Will", "Faisal", "Jon", "Michael", "David", "Devang", "Colin", "Josh", "Brianna", "Emily", "Joanne", "Adhvik", "Sam", "Alison", "Michelle", "Angus", "Jenn", "Lingxi", "Lauren", "Johnny", "Larry", "Maddy", "Vish", "Kevin", "Joey", "Jiajun", "Jordan", "Jordan", "Hanna", "Jules", "Rudy", "Davesh", "Chris", "Amrita", "Nicole", "Anurag", "Talal", "Aaditya", "Jennifer", "Dayna", "Matt", "Matt", "Julius", "Nathan", "Alex", "Paul", "Brian", "Holly", "Ryan", "Junyi", "Steph", "Sam", "Noah", "Kenneth", "Pranathi", "Jake", "Ray", "Maude", "Merrill", "Greg", "Tomas", "Michael", "Susan", "Jen", "Justin", "JD", "Julia", "Paul", "Tyler", "Janet", "April", "Serena"]
...
for row_idx, y, segment in all_segments:
    ...
    while pos_in_seg < seg_len:
        ...
        if is_first_row or is_last_row:
            ...
            # Name must not be at first or last char of segment
            # Need: at least 1 filler before (pos_in_seg >= 1) AND 1 filler after (name ends before last pos)
            not_at_start = pos_in_seg >= 1
            not_at_end = pos_in_seg + next_name_len < seg_len
...
# Save images
if shouldSave:
    saveImage(os.path.join(EXPORTS, "cursor-ad-7-" + currentTime.strftime("%Y%m%d-%H%M%S") + ".svg"))
    saveImage(os.path.join(EXPORTS, "cursor-ad-7-" + currentTime.strftime("%Y%m%d-%H%M%S") + ".png"))
    # saveImage("exports/graphics-" + currentTime.strftime("%Y%m%d-%H%M%S") + ".gif")
    # saveImage("exports/graphics-" + currentTime.strftime("%Y%m%d-%H%M%S") + ".mp4")
    pass
